...
<div id="window1" name="window" style="width:600px; height:250px;">
	<div class="windowtitlebar">
		<div id="windowtitle1" onClick="putWindowOnTop(1)" onmousedown="dragstart(1)" class="windowtitle"></div>
...
<div id="window2" name="window" style="width:600px; height:250px;">
	<div class="windowtitlebar">
		<div id="windowtitle2" onClick="putWindowOnTop(2)" onmousedown="dragstart(2)" class="windowtitle"></div>
...
<div id="window3" name="window" style="width:300px; height:300px;">
	<div class="funclisttitlebar">
		<div id="windowtitle3" onClick="putWindowOnTop(3)" onmousedown="dragstart(3)" class="funclisttitle">
...
<div id="window4" name="window" style="width:300px; height:300px;">
	<div class="funclisttitlebar">
		<div id="windowtitle4" onClick="putWindowOnTop(4)" onmousedown="dragstart(4)" class="funclisttitle">
		user input
		</div>
...
<div id="window5" name="window" style="width:300px; height:300px;">
	<div class="funclisttitlebar">
		<div id="windowtitle4" onClick="putWindowOnTop(5)" onmousedown="dragstart(5)" class="funclisttitle">
