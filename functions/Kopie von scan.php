		...
		{	
					...
					else
					{
						...
						while( $tokens[$i +$c] !== ';' )
						{
							...
							{		
								...
								{
									$inc_file .= substr($tokens[$i + $c][1], 1, -1);
								}
							}
							if($c>50)break;
							$c++;
			...
			// check if token is a function call and a function to scan
				...
				{						
					...
					//if(isset($GLOBALS['F_QUOTE_ANALYSIS'][$token_value]))
					//{
						echo $reconstructstr;
					//}
