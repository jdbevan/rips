...
**/
	...
	function scan_parameter($file_name, $mainparent, $parent, $var_name, $var_declares, $last_token_id, $var_declares_global, $function_params, $function_obj, $userinput, $F_SECURES, $return_scan=false, $ignore_securing=false, $secured='')
	{	
		$vardependent = false;
		$ignore_var = '';
		...
		if( in_array($arrayname[0], $function_params) && ($GLOBALS['verbosity'] >= 3 || empty($secured)) )
		{
